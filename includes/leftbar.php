...
if (isset($_SESSION["email"])) {
    ...
    ?>
            <img src="../images/people/<?php echo $_SESSION["image"]; ?>" alt="Admin" class="img-circle profile-img" style="width:30%">
            <h6 class="title"><?php echo $_SESSION["name"]; ?></h6>
            <small class="info"><?php echo $_SESSION["email"];} ?></small>
        </div>
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    <a href="#"><i class="fas fa-users-cog" style="margin-right:0.5rem"></i> <span>Student Classes</span> <i
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        ...
                        <li><a href="manage-students.php"><i class="fa fa fa-server"></i>
                                <span>Manage Students</span></a></li>
                    </ul>
                </li>
                <li class="has-children">
                    <a href="#"><i class="fas fa-poll" style="margin-right:0.75rem"></i> <span>Result</span> <i
                                class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
